...
UNIT_CATEGORIES = {
    "weight": {
        ...
        "aliases": {
            ...
            "ton": "ton", "tons": "ton", "mt": "ton", "metric_ton": "ton", "metric_tons": "ton",
            "bag": "bag", "bags": "bag",
    ...
    "countable": {
        "base": "piece",
        "aliases": {
            "piece": "piece", "pieces": "piece", "pcs": "piece", "pc": "piece", "unit": "piece", "units": "piece",
...
def convert_quantity(quantity: float, from_unit: str, to_unit: str) -> float:
    ...
    if from_cat != to_cat:
        raise ValueError(f"Incompatible unit categories: cannot convert from {from_unit} ({from_cat}) to {to_unit} ({to_cat})")
