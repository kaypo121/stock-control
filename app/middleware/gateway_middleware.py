...
class RequestContextMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request, call_next):
        ...
        response.headers["X-Processing-Time-Ms"] = f"{(time.perf_counter() - started) * 1000.0:.2f}"
        return response
    ...
    async def dispatch(self, request, call_next):
        ...
        return JSONResponse(
            ...
            content={
                ...
                "data": None,
                "errors": [{"code": "IP_NOT_ALLOWED", "message": "The caller IP address is not allow-listed."}],
                "warnings": [],
