...
from app.models.stock_models import Farmer
...
def seed_db():
    ...
    try:
        ...
        farmers_data = [
            {
                ...
                "phone_number": "+233241112222",
                "region": "Bono",
                "district": "Sunyani Municipal",
                "farm_name": "Mensah Farms",
            },
            {
                "full_name": "Kojo Annan",
                "phone_number": "+233243334444",
                "region": "Ashanti",
                "district": "Ejura Sekyedumase",
                "farm_name": "Annan Cocoa Enterprise",
            },
            {
                "full_name": "Ama Serwaa",
                "phone_number": "+233245556666",
                "region": "Volta",
                "district": "Ho Municipal",
                "farm_name": "Volta Roots Ltd",
            },
            {
                "full_name": "Abena Osei",
                "phone_number": "+233247778888",
                "region": "Greater Accra",
                "district": "Ada East",
                "farm_name": "Coastal Farm Group",
            },
        ]
        farmers = []
        ...
        products_data = [
            {
                ...
                "category": "Grains",
                "unit": "kg",
                "description": "Standard white grain maize",
            },
            {
                "product_name": "Maize Yellow",
                "category": "Grains",
                "unit": "kg",
                "description": "Yellow grain maize for poultry and feed",
            },
            {
                "product_name": "Rice Local",
                "category": "Grains",
                "unit": "kg",
                "description": "Local brown/white husked rice",
            },
            {
            ...
            {
                "product_name": "Yam Puna",
                "category": "Roots & Tubers",
                "unit": "piece",
                "description": "Premium Puna yam tubers",
            },
            {
                "product_name": "Tomato Local",
                "category": "Vegetables",
                "unit": "crate",
                "description": "Local garden fresh tomatoes",
            },
            {
        ...
        warehouses_data = [
            {
                "warehouse_name": "Sunyani Central Silo",
                "region": "Bono",
                "district": "Sunyani Municipal",
                "capacity": 10000.0,
            },
            {
                "warehouse_name": "Ejura Grain Depot",
                "region": "Ashanti",
                "district": "Ejura Sekyedumase",
                "capacity": 50000.0,
            },
            {
                "warehouse_name": "Ho Cooperative Vault",
                "region": "Volta",
                "district": "Ho Municipal",
                "capacity": 5000.0,
            },
            {
                "warehouse_name": "Agbogbloshie Market Shed",
                "region": "Greater Accra",
        ...
        bal_kofi_maize.reorder_level = (
            8000.0  # Current stock is 7500kg (150 bags), so this triggers LOW_STOCK!
        )
        db.commit()
